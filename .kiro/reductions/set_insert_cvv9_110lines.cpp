...
template <class _Alloc> struct allocator_traits {
  ...
  static __pointer<allocator_type>::type allocate() {
    typename allocator_type::size_type __n;
    allocator_type __a;
...
struct __compressed_pair : __compressed_pair_elem<__tree_node<int, void *> *>,
  ...
  __tree_node<int, void *> *first() { return __value_; }
};
struct __tree_node_destructor {
  typedef allocator<__tree_node<int, void *>>::pointer pointer;
...
struct __tree_node_types<_NodePtr, __tree_node<_Tp, _VoidPtr>> {
  ...
  typedef void *__node_base_pointer;
};
void *__left_;
...
__tree_node_types<
    __rebind_pointer_t<void *, __tree_node<int, void>>>::__node_base_pointer &
    __insert_unique___child(__left_);
unique_ptr __insert_unique___h = __construct_node();
__tree_node<int, void *> *__insert_unique___trans_tmp_2 =
    __insert_unique___h.get();
int count___k;
int main() {
  __insert_unique___child = __insert_unique___trans_tmp_2;
  less __trans_tmp_4;
  __trans_tmp_4(
