...
clauses. Applying the same methodology to
alternative encodings (Booth radix-4, 4-bit blocks, sorting
networks), we find that no single encoding dominates: Booth is
17$\times$ faster on strength-reduction benchmarks, while \combacs
is 2$\times$ faster on commutativity. The optimal encoding depends on
