...
{
  const std::vector<std::size_t> singleton = {1u};
  REQUIRE(format_number_range(singleton) == "1");

  const std::vector<std::size_t> r1 = {0u, 42u};
  REQUIRE(format_number_range(r1) == "0,42");

  const std::vector<std::size_t> r2 = {0u, 1u};
  REQUIRE(format_number_range(r2) == "0,1");

  const std::vector<std::size_t> r3 = {1u, 2u, 3u};
  REQUIRE(format_number_range(r3) == "1-3");

  const std::vector<std::size_t> r4 = {1u, 3u, 4u, 5u};
  REQUIRE(format_number_range(r4) == "1,3-5");

  const std::vector<std::size_t> r5 = {1u, 10u, 11u, 12u, 42u};
  REQUIRE(format_number_range(r5) == "1,10-12,42");

  const std::vector<std::size_t> r6 = {1u, 10u, 11u, 12u, 42u, 43u, 44u};
