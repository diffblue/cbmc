  ...
  GIVEN("Two simple signed intervals")
  {
    ...
    WHEN("<, >, <=, >=, ==, != are tested on expressions")
    {
      ...
      THEN("")
      {
        ...
        REQUIRE(interval_exprt::greater_than_or_equal(min_exprt(t), min_exprt(t)));

        REQUIRE(interval_exprt::greater_than(max_exprt(t), min_exprt(t)));
        REQUIRE(interval_exprt::greater_than_or_equal(max_exprt(t), min_exprt(t)));
    ...
    WHEN("<, >, <=, >=, ==, != are tested on intervals")
    {
      ...
      {
        CHECK(interval_exprt(v[10], v[29]).less_than(interval_exprt(v[30], v[40])) == tvt(true));
        CHECK(interval_exprt(v[10], v[30]).less_than(interval_exprt(v[30], v[40])) == tvt::unknown());
        CHECK(interval_exprt(v[10], v[31]).less_than(interval_exprt(v[30], v[40])) == tvt::unknown());

        CHECK(interval_exprt(v[30], v[40]).less_than(interval_exprt(v[10], v[29])) == tvt(false));
      ...
      {
        CHECK(interval_exprt(v[10], v[29]).greater_than(interval_exprt(v[30], v[40])) == tvt(false));
        CHECK(interval_exprt(v[10], v[29]).greater_than(interval_exprt(v[30], v[40])) ==
            interval_exprt(v[30], v[40]).less_than(interval_exprt(v[10], v[29])));


        CHECK(interval_exprt(v[10], v[30]).greater_than(interval_exprt(v[30], v[40])) == tvt::unknown());
        CHECK(interval_exprt(v[10], v[31]).greater_than(interval_exprt(v[30], v[40])) == tvt::unknown());
      }

      THEN("[10, 29] <= [30, 40] == true, [10, 30] <= [30, 40] == true, [10, 31] <- [30, 40] == unknown")
      {
        CHECK(interval_exprt(v[10], v[29]).less_than_or_equal(interval_exprt(v[30], v[40])) == tvt(true));
        CHECK(interval_exprt(v[10], v[30]).less_than_or_equal(interval_exprt(v[30], v[40])) == tvt(true));
        CHECK(interval_exprt(v[10], v[31]).less_than_or_equal(interval_exprt(v[30], v[40])) == tvt::unknown());
      }

      THEN("[10, 29] >= [30, 40] == false, [10, 30] >= [30, 40] == unknown, [10, 31] >= [30, 40] == unknown")
      {
        CHECK(interval_exprt(v[10], v[29]).greater_than_or_equal(interval_exprt(v[30], v[40])) == tvt(false));
        CHECK(interval_exprt(v[10], v[30]).greater_than_or_equal(interval_exprt(v[30], v[40])) == tvt::unknown());
        CHECK(interval_exprt(v[10], v[31]).greater_than_or_equal(interval_exprt(v[30], v[40])) == tvt::unknown());
      }
    }
  }
}
