...
(assert (= (cprover.str.len string.1) (_ bv0 32)))
; set_to true (equal)
...
(define-fun string_concat.s0.2 () cprover.String |main::1::a!0@1#1|)
...
(assert (= (select string.3 (_ bv1 32)) (_ bv117 8)))
(assert (= (select string.3 (_ bv2 32)) (_ bv109 8)))
