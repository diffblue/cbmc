...
; set_to true
(assert (= |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$7!0@1#2| (= |main::1::y!0@1#1| |main::1::x!0@1#1|)))

(declare-fun string_length.0 () (_ BitVec 32))
(assert (= (cprover.ubv_to_int |string_length.0|) (str.len |main::1::y!0@1#1|)))
; set_to true (equal)
(define-fun |main::$tmp::return_value___CPROVER_uninterpreted_strlen$6!0@1#2| () (_ BitVec 32) string_length.0)

; set_to true
(assert (= |goto_symex::&92;guard#1| (= |main::$tmp::return_value___CPROVER_uninterpreted_strlen$6!0@1#2| (_ bv4 32))))

(define-fun string.1 () cprover.String "fg")
; set_to true (equal)
...
(define-fun string.2 () cprover.String "abcd")
; set_to true (equal)
