...
; convert
(define-fun |B2| () Bool |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$4!0@1#2|)

; convert
(define-fun |B3| () Bool |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$4!0@1#2|)

; convert
(define-fun |B4| () Bool |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$4!0@1#2|)

; find_symbols
(declare-fun |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$2!0@1#2| () Bool)
; convert
(define-fun |B5| () Bool (and |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$4!0@1#2| |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$2!0@1#2|))
...
(assert (= (select string.1 (_ bv3 32)) (_ bv10 8)))
(assert (= (select string.1 (_ bv4 32)) (_ bv101 8)))
(assert (= (select string.1 (_ bv5 32)) (_ bv102 8)))
(assert (= (select string.1 (_ bv6 32)) (_ bv103 8)))
(assert (= (select string.1 (_ bv7 32)) (_ bv32 8)))
(assert (= (select string.1 (_ bv8 32)) (_ bv32 8)))
(assert (= (cprover.str.len string.1) (_ bv9 32)))
; set_to true (equal)
...
(assert (= (select string.3 (_ bv0 32)) (_ bv122 8)))
(assert (= (select string.3 (_ bv1 32)) (_ bv95 8)))
(assert (= (select string.3 (_ bv2 32)) (_ bv9 8)))
(assert (= (select string.3 (_ bv3 32)) (_ bv95 8)))
(assert (= (select string.3 (_ bv4 32)) (_ bv122 8)))
(assert (= (select string.3 (_ bv5 32)) (_ bv45 8)))
(assert (= (select string.3 (_ bv6 32)) (_ bv9 8)))
(assert (= (select string.3 (_ bv7 32)) (_ bv45 8)))
(assert (= (select string.3 (_ bv8 32)) (_ bv92 8)))
(assert (= (select string.3 (_ bv9 32)) (_ bv39 8)))
(assert (= (select string.3 (_ bv10 32)) (_ bv61 8)))
(assert (= (select string.3 (_ bv11 32)) (_ bv34 8)))
(assert (= (select string.3 (_ bv12 32)) (_ bv95 8)))
(assert (= (select string.3 (_ bv13 32)) (_ bv122 8)))
(assert (= (cprover.str.len string.3) (_ bv14 32)))
; set_to true (equal)
...
(define-fun string_equal.s1.4 () cprover.String |main::1::y1!0@1#1|)
(define-fun string_equal.s2.4 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$1!0@1#2|)
...
; set_to true
(assert (= |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$2!0@1#2| string_equal.4))

; convert
(define-fun |B6| () Bool (= |main::1::x!0@1#1| |main::1::x!0@1#1|))

; convert
(define-fun |B7| () Bool (= |main::1::y1!0@1#1| |main::1::y1!0@1#1|))

; find_symbols
(declare-fun |main::1::y2!0@1#1| () cprover.String)
; convert
(define-fun |B8| () Bool (= |main::1::y2!0@1#1| |main::1::y2!0@1#1|))

; find_symbols
(declare-fun |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$3!0@1#1| () cprover.String)
; convert
(define-fun |B9| () Bool (= |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$3!0@1#1| |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$3!0@1#1|))

; find_symbols
(declare-fun |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$4!0@1#1| () Bool)
; convert
(define-fun |B10| () Bool (= |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$4!0@1#1| |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$4!0@1#1|))

; find_symbols
(declare-fun |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$1!0@1#1| () cprover.String)
; convert
(define-fun |B11| () Bool (= |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$1!0@1#1| |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$1!0@1#1|))

; find_symbols
(declare-fun |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$2!0@1#1| () Bool)
; convert
(define-fun |B12| () Bool (= |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$2!0@1#1| |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$2!0@1#1|))
...
; convert
(define-fun |B13| () Bool (not |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$4!0@1#2|))

; convert
(define-fun |B14| () Bool (not |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$2!0@1#2|))
