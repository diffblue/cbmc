...
(define-fun string_concat.s0.1 () cprover.String |main::1::v1!0@1#1|)
(define-fun string_concat.s1.1 () cprover.String |main::1::v2!0@1#1|)
...
(assert (= (select string.2 (_ bv0 32)) (_ bv101 8)))
...
(define-fun string_concat.s0.3 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_strcat$1!0@1#2|)
