...
; find_symbols
(declare-fun |main::1::v1!0@1#1| () cprover.String)
; find_symbols
(declare-fun |main::1::v2!0@1#1| () cprover.String)
; set_to true (equal)
(define-fun |main::$tmp::return_value___CPROVER_uninterpreted_strcat$1!0@1#2| () cprover.String (str.++ |main::1::v1!0@1#1| |main::1::v2!0@1#1|))

(define-fun string.1 () cprover.String "e")
; set_to true (equal)
(define-fun |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$2!0@1#2| () cprover.String string.1)

; set_to true (equal)
(define-fun |main::$tmp::return_value___CPROVER_uninterpreted_strcat$3!0@1#2| () cprover.String (str.++ |main::$tmp::return_value___CPROVER_uninterpreted_strcat$1!0@1#2| |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$2!0@1#2|))
...
; convert
(define-fun |B1| () Bool (= |main::1::v1!0@1#1| |main::1::v1!0@1#1|))

; convert
(define-fun |B2| () Bool (= |main::1::v2!0@1#1| |main::1::v2!0@1#1|))
...
; convert
(define-fun |B9| () Bool (= |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$5!0@1#1| |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$5!0@1#1|))

; set_to true
(assert |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$5!0@1#2|)

; convert
(define-fun |B10| () Bool (not |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$5!0@1#2|))
...
(get-value (|main::1::v1!0@1#1|))
(get-value (|main::1::v2!0@1#1|))
