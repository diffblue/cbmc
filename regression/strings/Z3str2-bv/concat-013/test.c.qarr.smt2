...
(define-fun string_concat.s0.2 () cprover.String |main::1::z!0@1#1|)
(define-fun string_concat.s1.2 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$3!0@1#2|)
...
(assert (= (cprover.str.len string.5) (_ bv0 32)))
; set_to true (equal)
