...
(assert (= (select string.4 (_ bv0 32)) (_ bv98 8)))
(assert (= (select string.4 (_ bv1 32)) (_ bv97 8)))
...
(define-fun string_concat.s1.5 () cprover.String |main::1::X!0@1#1|)
...
; convert
(define-fun |B9| () Bool (= |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$5!0@1#1| |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$5!0@1#1|))
...
; convert
(define-fun |B12| () Bool (= |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$8!0@1#1| |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$8!0@1#1|))
...
; convert
(define-fun |B14| () Bool (not |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$8!0@1#2|))

; convert
(define-fun |B15| () Bool (not (= |main::$tmp::return_value___CPROVER_uninterpreted_strlen$1!0@1#2| (_ bv2 32))))
