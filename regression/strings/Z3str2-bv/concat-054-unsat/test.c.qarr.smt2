...
(assert (= (select string.1 (_ bv2 32)) (_ bv107 8)))
(assert (= (select string.1 (_ bv3 32)) (_ bv101 8)))
(assert (= (select string.1 (_ bv4 32)) (_ bv102 8)))
(assert (= (select string.1 (_ bv5 32)) (_ bv103 8)))
(assert (= (select string.1 (_ bv6 32)) (_ bv104 8)))
...
(assert (= (cprover.str.len string.3) (_ bv3 32)))
; set_to true (equal)
