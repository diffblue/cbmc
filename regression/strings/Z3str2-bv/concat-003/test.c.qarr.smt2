...
; convert
(define-fun |B3| () Bool |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$5!0@1#2|)

; convert
(define-fun |B4| () Bool |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$5!0@1#2|)

; find_symbols
(declare-fun |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$2!0@1#2| () Bool)
; convert
(define-fun |B5| () Bool (and |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$5!0@1#2| |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$2!0@1#2|))
...
(assert (= (select string.4 (_ bv0 32)) (_ bv116 8)))
(assert (= (select string.4 (_ bv1 32)) (_ bv101 8)))
(assert (= (select string.4 (_ bv2 32)) (_ bv115 8)))
(assert (= (select string.4 (_ bv3 32)) (_ bv116 8)))
(assert (= (select string.4 (_ bv4 32)) (_ bv104 8)))
(assert (= (select string.4 (_ bv5 32)) (_ bv101 8)))
(assert (= (cprover.str.len string.4) (_ bv6 32)))
; set_to true (equal)
...
(define-fun string_equal.s1.5 () cprover.String |main::1::a!0@1#1|)
...
; convert
(define-fun |B6| () Bool (= |main::1::a!0@1#1| |main::1::a!0@1#1|))

; convert
(define-fun |B7| () Bool (= |main::1::b!0@1#1| |main::1::b!0@1#1|))
...
; convert
(define-fun |B12| () Bool (= |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$1!0@1#1| |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$1!0@1#1|))

; find_symbols
(declare-fun |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$2!0@1#1| () Bool)
; convert
(define-fun |B13| () Bool (= |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$2!0@1#1| |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$2!0@1#1|))
...
; convert
(define-fun |B15| () Bool (not |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$2!0@1#2|))
