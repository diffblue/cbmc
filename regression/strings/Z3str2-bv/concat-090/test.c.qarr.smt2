...
(define-fun string_concat.s1.1 () cprover.String |main::1::Y1!0@1#1|)
...
(define-fun string_concat.s0.2 () cprover.String |main::1::Y2!0@1#1|)
...
(define-fun string_equal.s1.3 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_strcat$4!0@1#2|)
(define-fun string_equal.s2.3 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_strcat$5!0@1#2|)
...
; set_to true
(assert (= |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$6!0@1#2| string_equal.3))
...
(define-fun string_concat.s1.4 () cprover.String |main::1::Y3!0@1#1|)
...
; set_to true (equal)
(define-fun |main::$tmp::return_value___CPROVER_uninterpreted_strcat$1!0@1#2| () cprover.String string_concat.4)

; find_symbols
(declare-fun |main::1::Y4!0@1#1| () cprover.String)
; string concatenation
(declare-fun string_concat.5 () cprover.String)
(define-fun string_concat.s0.5 () cprover.String |main::1::Y4!0@1#1|)
...
; set_to true (equal)
(define-fun |main::$tmp::return_value___CPROVER_uninterpreted_strcat$2!0@1#2| () cprover.String string_concat.5)

; string equal
(declare-fun string_equal.6 () Bool)
(define-fun string_equal.s1.6 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_strcat$1!0@1#2|)
(define-fun string_equal.s2.6 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_strcat$2!0@1#2|)
...
; set_to true
(assert (= |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$3!0@1#2| string_equal.6))
