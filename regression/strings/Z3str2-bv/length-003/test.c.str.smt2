...
(define-fun string.1 () cprover.String "abcde")
; set_to true (equal)
...
; set_to true
(assert (= |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$4!0@1#2| (= |main::1::y!0@1#1| |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$3!0@1#2|)))

; find_symbols
(declare-fun |main::1::x!0@1#1| () cprover.String)
; set_to true
(assert (= |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$2!0@1#2| (= |main::1::y!0@1#1| |main::1::x!0@1#1|)))
