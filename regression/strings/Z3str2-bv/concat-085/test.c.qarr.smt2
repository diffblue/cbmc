...
(define-fun string_concat.s0.2 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$8!0@1#2|)
...
; set_to true (equal)
(define-fun |main::$tmp::return_value___CPROVER_uninterpreted_strcat$9!0@1#2| () cprover.String string_concat.2)
...
(define-fun string_equal.s2.3 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_strcat$9!0@1#2|)
...
; set_to true
(assert (= |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$10!0@1#2| string_equal.3))

(declare-fun string.4 () cprover.String)
(assert (= (select string.4 (_ bv0 32)) (_ bv99 8)))
(assert (= (select string.4 (_ bv1 32)) (_ bv101 8)))
...
(define-fun string_concat.s1.5 () cprover.String |main::1::m2!0@1#1|)
...
(define-fun string_concat.s0.6 () cprover.String |main::1::t_str5!0@1#1|)
...
(define-fun string_equal.s1.7 () cprover.String |main::1::z!0@1#1|)
...
(assert (= (select string.8 (_ bv0 32)) (_ bv97 8)))
(assert (= (select string.8 (_ bv1 32)) (_ bv98 8)))
(assert (= (select string.8 (_ bv2 32)) (_ bv99 8)))
(assert (= (select string.8 (_ bv3 32)) (_ bv64 8)))
(assert (= (cprover.str.len string.8) (_ bv4 32)))
; set_to true (equal)
...
; string concatenation
(declare-fun string_concat.9 () cprover.String)
(define-fun string_concat.s0.9 () cprover.String |main::1::t_str2!0@1#1|)
(define-fun string_concat.s1.9 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$1!0@1#2|)
(assert (forall ((?n cprover.Pos)) (=> (bvult ?n (cprover.str.len string_concat.s0.9)) (= (select string_concat.s0.9 ?n) (select string_concat.9 ?n)))))
(assert (forall ((?n cprover.Pos)) (=> (bvult ?n (cprover.str.len string_concat.s1.9)) (= (select string_concat.s1.9 ?n) (select string_concat.9 (bvadd (cprover.str.len string_concat.s0.9) ?n))))))
(assert (= (cprover.str.len string_concat.9) (bvadd (cprover.str.len string_concat.s0.9) (cprover.str.len string_concat.s1.9))))
(assert (bvuge (cprover.str.len string_concat.9) (cprover.str.len string_concat.s0.9)))
(assert (bvuge (cprover.str.len string_concat.9) (cprover.str.len string_concat.s1.9)))

; set_to true (equal)
(define-fun |main::$tmp::return_value___CPROVER_uninterpreted_strcat$2!0@1#2| () cprover.String string_concat.9)

; string equal
(declare-fun string_equal.10 () Bool)
(define-fun string_equal.s1.10 () cprover.String |main::1::z!0@1#1|)
(define-fun string_equal.s2.10 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_strcat$2!0@1#2|)
...
; set_to true
(assert (= |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$3!0@1#2| string_equal.10))
