...
(assert (= (select string.1 (_ bv0 32)) (_ bv104 8)))
(assert (= (select string.1 (_ bv1 32)) (_ bv101 8)))
(assert (= (select string.1 (_ bv2 32)) (_ bv108 8)))
(assert (= (select string.1 (_ bv3 32)) (_ bv108 8)))
(assert (= (select string.1 (_ bv4 32)) (_ bv111 8)))
...
(define-fun string_concat.s0.4 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_strcat$2!0@1#2|)
