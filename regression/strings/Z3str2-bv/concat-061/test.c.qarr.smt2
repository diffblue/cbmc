...
(assert (= (select string.1 (_ bv0 32)) (_ bv107 8)))
(assert (= (select string.1 (_ bv1 32)) (_ bv95 8)))
(assert (= (select string.1 (_ bv2 32)) (_ bv103 8)))
(assert (= (select string.1 (_ bv3 32)) (_ bv104 8)))
(assert (= (select string.1 (_ bv4 32)) (_ bv105 8)))
(assert (= (select string.1 (_ bv5 32)) (_ bv97 8)))
(assert (= (select string.1 (_ bv6 32)) (_ bv98 8)))
(assert (= (cprover.str.len string.1) (_ bv7 32)))
; set_to true (equal)
