...
(define-fun string_concat.s1.3 () cprover.String |main::1::y!0@1#1|)
...
; convert
(define-fun |B13| () Bool (not (= |main::$tmp::return_value___CPROVER_uninterpreted_strlen$1!0@1#2| (_ bv1 32))))
