...
(define-fun string_concat.s0.1 () cprover.String |main::1::m!0@1#1|)
(define-fun string_concat.s1.1 () cprover.String |main::1::n!0@1#1|)
...
; set_to true
(assert (= |goto_symex::&92;guard#2| (= |main::$tmp::return_value___CPROVER_uninterpreted_strlen$1!0@1#2| (_ bv0 32))))

; convert
(define-fun |B7| () Bool (= |main::1::m!0@1#1| |main::1::m!0@1#1|))

; convert
(define-fun |B8| () Bool (= |main::1::n!0@1#1| |main::1::n!0@1#1|))

; convert
(define-fun |B9| () Bool (= |main::1::x!0@1#1| |main::1::x!0@1#1|))

; convert
(define-fun |B10| () Bool (= |main::1::y!0@1#1| |main::1::y!0@1#1|))
...
; convert
(define-fun |B13| () Bool (= |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$5!0@1#1| |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$5!0@1#1|))
...
; convert
(define-fun |B16| () Bool (not |main::$tmp::return_value___CPROVER_uninterpreted_string_equal$5!0@1#2|))

; convert
(define-fun |B17| () Bool (not (= |main::$tmp::return_value___CPROVER_uninterpreted_strlen$2!0@1#2| (_ bv1 32))))

; convert
(define-fun |B18| () Bool (not (= |main::$tmp::return_value___CPROVER_uninterpreted_strlen$1!0@1#2| (_ bv0 32))))
