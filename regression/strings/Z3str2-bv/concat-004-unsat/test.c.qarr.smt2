...
(assert (= (select string.4 (_ bv2 32)) (_ bv108 8)))
(assert (= (select string.4 (_ bv3 32)) (_ bv108 8)))
(assert (= (select string.4 (_ bv4 32)) (_ bv111 8)))
(assert (= (cprover.str.len string.4) (_ bv5 32)))
; set_to true (equal)
