...
(assert (= (select string.2 (_ bv0 32)) (_ bv104 8)))
(assert (= (select string.2 (_ bv1 32)) (_ bv101 8)))
(assert (= (select string.2 (_ bv2 32)) (_ bv108 8)))
(assert (= (select string.2 (_ bv3 32)) (_ bv108 8)))
(assert (= (select string.2 (_ bv4 32)) (_ bv111 8)))
(assert (= (cprover.str.len string.2) (_ bv5 32)))
; set_to true (equal)
...
(define-fun string_concat.s1.3 () cprover.String |main::1::a!0@1#1|)
...
(define-fun string_concat.s0.4 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$1!0@1#2|)
...
(assert (= (select string.5 (_ bv0 32)) (_ bv116 8)))
(assert (= (select string.5 (_ bv1 32)) (_ bv101 8)))
(assert (= (select string.5 (_ bv2 32)) (_ bv115 8)))
(assert (= (select string.5 (_ bv3 32)) (_ bv116 8)))
(assert (= (select string.5 (_ bv4 32)) (_ bv104 8)))
(assert (= (select string.5 (_ bv5 32)) (_ bv101 8)))
(assert (= (select string.5 (_ bv6 32)) (_ bv108 8)))
(assert (= (select string.5 (_ bv7 32)) (_ bv108 8)))
(assert (= (select string.5 (_ bv8 32)) (_ bv111 8)))
(assert (= (select string.5 (_ bv9 32)) (_ bv110 8)))
(assert (= (select string.5 (_ bv10 32)) (_ bv117 8)))
(assert (= (select string.5 (_ bv11 32)) (_ bv109 8)))
(assert (= (cprover.str.len string.5) (_ bv12 32)))
; set_to true (equal)
...
(define-fun string_equal.s2.6 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$5!0@1#2|)
