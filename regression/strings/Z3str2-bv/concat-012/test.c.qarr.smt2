...
(assert (= (select string.1 (_ bv4 32)) (_ bv110 8)))
(assert (= (select string.1 (_ bv5 32)) (_ bv117 8)))
(assert (= (select string.1 (_ bv6 32)) (_ bv109 8)))
(assert (= (select string.1 (_ bv7 32)) (_ bv110 8)))
(assert (= (select string.1 (_ bv8 32)) (_ bv117 8)))
(assert (= (select string.1 (_ bv9 32)) (_ bv109 8)))
(assert (= (cprover.str.len string.1) (_ bv10 32)))
; set_to true (equal)
...
(assert (= (select string.2 (_ bv0 32)) (_ bv110 8)))
(assert (= (select string.2 (_ bv1 32)) (_ bv117 8)))
(assert (= (select string.2 (_ bv2 32)) (_ bv109 8)))
...
(define-fun string_concat.s0.3 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$2!0@1#2|)
(define-fun string_concat.s1.3 () cprover.String |main::1::x!0@1#1|)
...
(define-fun string_equal.s1.5 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$1!0@1#2|)
