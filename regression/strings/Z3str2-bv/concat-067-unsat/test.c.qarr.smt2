...
(assert (= (select string.3 (_ bv0 32)) (_ bv99 8)))
...
(define-fun string_concat.s0.4 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_string_literal$4!0@1#2|)
(define-fun string_concat.s1.4 () cprover.String |main::1::J!0@1#1|)
...
(define-fun string_concat.s0.5 () cprover.String |main::1::I!0@1#1|)
(define-fun string_concat.s1.5 () cprover.String |main::$tmp::return_value___CPROVER_uninterpreted_strcat$5!0@1#2|)
