 ...
 ******************************************************************************/
/* returns s[p] */
#define __CPROVER_char_at(s, p) __CPROVER_uninterpreted_char_at_func(s, p)
...
#define __CPROVER_string_concat(s1, s2) __CPROVER_uninterpreted_concat_func(s1, s2)
...
#define __CPROVER_string_substring(s, i, j) __CPROVER_uninterpreted_substring_func(s, i, j)

/* test whether p is a prefix of s */
#define __CPROVER_string_isprefix(p, s) __CPROVER_uninterpreted_string_prefix_of_func(p, s)

/* test whether p is a suffix of s */
#define __CPROVER_string_issuffix(p, s) __CPROVER_uninterpreted_string_suffix_of_func(p, s)
...
#define __CPROVER_string_last_index_of(s, c) __CPROVER_uninterpreted_string_lastindex_of_func(s, c)
...
#define __CPROVER_parse_int(s) __CPROVER_uninterpreted_parse_int_func(s)
 ...
 ******************************************************************************/
extern __CPROVER_char __CPROVER_uninterpreted_char_at_func(__CPROVER_string str, int pos);
...
extern __CPROVER_string __CPROVER_uninterpreted_concat_func(__CPROVER_string str1, __CPROVER_string str2);
extern int __CPROVER_uninterpreted_string_length_func(__CPROVER_string str);
extern __CPROVER_string __CPROVER_uninterpreted_substring_func(__CPROVER_string str, int i, int j);
extern __CPROVER_bool __CPROVER_uninterpreted_string_is_prefix_func(__CPROVER_string pref, __CPROVER_string str);
extern __CPROVER_bool __CPROVER_uninterpreted_string_is_suffix_of_func(__CPROVER_string suff, __CPROVER_string str);
...
extern unsigned __CPROVER_uninterpreted_parse_int_func(__CPROVER_string str);
