...
int main() {
  ...
  fence();
  // EXPECT:exists
  __CPROVER_assert(!(y==2 && __unbuffered_p1_EAX==1 && __unbuffered_p2_EAX==1 && __unbuffered_p2_EBX==1), "Program was expected to be safe for X86, model checker should have said NO.\nThis likely is a bug in the tool chain.");
  return 0;
}
