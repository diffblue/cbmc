...
int main() {
  ...
  fence();
  // EXPECT:exists
  __CPROVER_assert(!(x==2 && y==2 && __unbuffered_p0_r1==2 && __unbuffered_p0_r4==0 && __unbuffered_p2_r1==2 && __unbuffered_p2_r4==0), "Program proven to be relaxed for PPC, model checker says YES.");
  return 0;
}
