...
int main() {
  ...
  fence();
  // EXPECT:exists
  __CPROVER_assert(!(x==2 && __unbuffered_p0_EAX==0 && __unbuffered_p2_EAX==2 && __unbuffered_p2_EBX==0), "Program was expected to be safe for X86, model checker should have said NO.\nThis likely is a bug in the tool chain.");
  return 0;
}
