...
int main() {
  ...
  fence();
  // EXPECT:exists
  __CPROVER_assert(!(__unbuffered_p0_r5==0 && __unbuffered_p1_r5==0 && __unbuffered_p2_r5==0), "Program proven to be relaxed for PPC, model checker says YES.");
  return 0;
}
