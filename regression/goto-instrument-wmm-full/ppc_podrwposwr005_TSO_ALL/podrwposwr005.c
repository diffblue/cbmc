...
void * P1(void * arg) {
  ...
  __unbuffered_p1_r5 = z;
  __unbuffered_p1_r6 = __unbuffered_p1_r5 ^ __unbuffered_p1_r5;
  __unbuffered_p1_r7 = *(&x + __unbuffered_p1_r6);
  // Instrumentation for CPROVER
  fence();
  __unbuffered_cnt++;
}
...
int main() {
  ...
  fence();
  // EXPECT:exists
  __CPROVER_assert(!(__unbuffered_p1_r1==1 && __unbuffered_p1_r7==0), "Program proven to be relaxed for PPC, model checker says YES.");
  return 0;
}
