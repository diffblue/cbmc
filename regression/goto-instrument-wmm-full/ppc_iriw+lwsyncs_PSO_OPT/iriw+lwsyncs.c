...
int main() {
  ...
  fence();
  // EXPECT:exists
  __CPROVER_assert(!(__unbuffered_p1_r1==1 && __unbuffered_p1_r3==0 && __unbuffered_p3_r1==1 && __unbuffered_p3_r3==0), "Program proven to be relaxed for PPC, model checker says YES.");
  return 0;
}
