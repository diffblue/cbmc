...
int main() {
  ...
  fence();
  // EXPECT:exists
  __CPROVER_assert(!(z==2 && __unbuffered_p1_r1==1 && __unbuffered_p2_r1==1 && __unbuffered_p2_r5==1), "Program proven to be relaxed for PPC, model checker says YES.");
  return 0;
}
