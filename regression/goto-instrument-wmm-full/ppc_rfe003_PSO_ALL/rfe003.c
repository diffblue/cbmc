...
void * P2(void * arg) {
  ...
  *(&y + __unbuffered_p2_r3) = __unbuffered_p2_r4;
  // Instrumentation for CPROVER
  fence();
  __unbuffered_cnt++;
}
...
int main() {
  ...
  fence();
  // EXPECT:exists
  __CPROVER_assert(!(__unbuffered_p0_r1==1 && __unbuffered_p0_r4==0 && __unbuffered_p2_r1==1), "Program proven to be relaxed for PPC, model checker says YES.");
  return 0;
}
