...
void * P2(void * arg) {
  ...
  __unbuffered_p2_r4 = __unbuffered_p2_r3 ^ __unbuffered_p2_r3;
  __unbuffered_p2_r5 = *(&x + __unbuffered_p2_r4);
  // Instrumentation for CPROVER
  fence();
  __unbuffered_cnt++;
}
...
int main() {
  ...
  fence();
  // EXPECT:exists
  __CPROVER_assert(!(y==2 && __unbuffered_p0_r5==0 && __unbuffered_p1_r3==1 && __unbuffered_p2_r5==0), "Program proven to be relaxed for PPC, model checker says YES.");
  return 0;
}
