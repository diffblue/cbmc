...
int main() {
  ...
  fence();
  // EXPECT:exists
  __CPROVER_assert(!(__unbuffered_p0_r1==1 && __unbuffered_p0_r6==1 && __unbuffered_p1_r1==1 && __unbuffered_p1_r6==1 && __unbuffered_p2_r1==1), "Program was expected to be safe for PPC, model checker should have said NO.\nThis likely is a bug in the tool chain.");
  return 0;
}
