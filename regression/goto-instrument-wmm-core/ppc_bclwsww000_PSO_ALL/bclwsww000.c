...
void *P0(void *arg)
{
  ...
  __unbuffered_p0_r4 = *(&x + __unbuffered_p0_r3);
...
void *P2(void *arg)
{
  ...
  __unbuffered_p2_r4 = *(&y + __unbuffered_p2_r3);
  // Instrumentation for CPROVER
  fence();
  __unbuffered_cnt++;
}
...
void *P3(void *arg)
{
  ...
  lwfence();
  __unbuffered_p3_r3 = 2;
  y = __unbuffered_p3_r3;
  // Instrumentation for CPROVER
  fence();
  __unbuffered_cnt++;
}
...
__CPROVER_ASYNC_3:
  ...
  // EXPECT:exists
  __CPROVER_assert(
    !(x == 2 && y == 2 && __unbuffered_p0_r1 == 2 && __unbuffered_p0_r4 == 0 &&
      __unbuffered_p2_r1 == 2 && __unbuffered_p2_r4 == 0),
