...
int main() {
  ...
  fence();
  // EXPECT:exists
  __CPROVER_assert(!(__unbuffered_p0_r1==1 && __unbuffered_p0_r3==0 && __unbuffered_p2_r1==1 && __unbuffered_p2_r3==0), "Program proven to be relaxed for PPC, model checker says YES.");
  return 0;
}
