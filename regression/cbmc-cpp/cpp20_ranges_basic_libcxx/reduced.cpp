...
struct __perfect_forward_impl< _Op, integer_sequence< unsigned long, _Idx... >, _BoundArgs... > {
  template < class... _Args >
  auto operator()(_Args... __args) -> decltype(_Op()(_Idx..., __args...));
};
template < class _Op, class... _Args >
using __perfect_forward = __perfect_forward_impl< _Op, integer_sequence< unsigned long, 0 > >;
namespace ranges {
template < class _Tp >
