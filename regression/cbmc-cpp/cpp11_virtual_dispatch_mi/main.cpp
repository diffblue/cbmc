...
struct Concrete : B0,B1,B2,B3,B4,B5,B6,B7,B8 {
    bool value;
    bool f0() override { return false; } bool f1() override { return false; }
    bool f2() override { return false; } bool f3() override { return false; }
    bool f4() override { return false; } bool f5() override { return false; }
    bool f6() override { return false; } bool f7() override { return false; }
    bool guard() override { return value; }

    bool run() { return B8::eval(); }  // qualified call — triggers the bug
};
