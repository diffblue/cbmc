...
#include <vector>
template <class A, class B, bool same_size>
...
struct ranget
{
  ...
  ranget<zip_iteratort<It, other_iteratort, same_size>>
  zip(ranget<other_iteratort> other)
  {
    return ranget<zip_iteratort<It, other_iteratort, same_size>>{
      {b, other.b}, {e, other.e}};
  }
...
int main()
{
  ...
  __CPROVER_assert(
    *z.b.a == 4 && *z.b.b == 1,
    "zip over a container: inner call with an rvalue ranget picks the by-value "
    "overload");
  return 0;
}
