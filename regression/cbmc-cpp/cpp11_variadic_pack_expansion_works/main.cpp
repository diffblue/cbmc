...
int main()
{
  ...
  __CPROVER_assert(
    call3(x, y, z) == g3(x, y, z), "value-pack call, 3 elements");
  __CPROVER_assert(
    outer(x, y, z) == g3(x, y, z), "value-pack forward, two layers");

  wrap<int, char, long>::type t;
  __CPROVER_assert(
    t.count() == 3, "type-pack class-template argument, 3 elements");
