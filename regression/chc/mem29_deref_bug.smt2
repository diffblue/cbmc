...
(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|memor_1| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|alloc_1| (Array (_ BitVec 64) (_ BitVec 64))) (|main::1::1::i| (_ BitVec 64)) (|main::1::L| (_ BitVec 64)) (|main::1::M| (_ BitVec 64)))
  (=> (and 
    (|inv_10| |main::1::1::i| |main::1::L| |main::1::M| |alloc_1| |memor_1|)
       (= |memor_0| (store |memor_1| (select |alloc_0| (_ bv2 64)) (store (select |memor_1| (select |alloc_0| (_ bv2 64))) |main::1::1::i| (_ bv1 64))))
       (= |alloc_0| (store |alloc_1| (_ bv2 64) (select |alloc_1| (_ bv4 64))))
       (or (= (select |alloc_0| (_ bv2 64)) (_ bv0 64)) (= (select |alloc_1| (_ bv4 64)) (_ bv0 64)))) false)))
...
(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|memor_1| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|alloc_1| (Array (_ BitVec 64) (_ BitVec 64))) (|main::1::1::i| (_ BitVec 64)) (|main::1::L| (_ BitVec 64)) (|main::1::M| (_ BitVec 64)))
  (=> (and 
    (|inv_8| |main::1::1::i| |main::1::L| |main::1::M| |alloc_1| |memor_1|)
       (= |memor_0| (store |memor_1| (select |alloc_0| (_ bv1 64)) (store (select |memor_1| (select |alloc_0| (_ bv1 64))) |main::1::1::i| (_ bv0 64))))
       (= |alloc_0| (store |alloc_1| (_ bv1 64) (select |alloc_1| (_ bv3 64))))
       (or (= (select |alloc_0| (_ bv1 64)) (_ bv0 64)) (= (select |alloc_1| (_ bv3 64)) (_ bv0 64)))) false)))
...
(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|memor_1| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|memor_2| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|main::1::1::i| (_ BitVec 64)) (|main::1::L| (_ BitVec 64)) (|main::1::M| (_ BitVec 64)))
  (=> (and 
    (|inv_5| |main::1::1::i| |main::1::L| |main::1::M| |alloc_0| |memor_2|)
       (= |memor_0| (store |memor_1| (select |alloc_0| (_ bv1 64)) (store (select |memor_1| (select |alloc_0| (_ bv1 64))) |main::1::1::i| (_ bv1 64))))
       (= |memor_1| (store |memor_2| (select |alloc_0| (_ bv2 64)) (store (select |memor_2| (select |alloc_0| (_ bv2 64))) |main::1::1::i| (_ bv0 64))))
