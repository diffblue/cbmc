...
(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|main::1::L| (_ BitVec 64)) (|main::1::i| (_ BitVec 64)) (|main::1::j| (_ BitVec 64)))
  (=> (and 
    (|inv_7| |main::1::L| |main::1::i| |main::1::j| |alloc_0| |memor_0|)
       (not (and (not (bvuge (bvadd |main::1::j| (_ bv1 64)) |main::1::i|))
...
(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|main::1::L| (_ BitVec 64)) (|main::1::i| (_ BitVec 64)) (|main::1::j| (_ BitVec 64)))
  (=> (and 
    (|inv_5| |main::1::L| |main::1::i| |main::1::j| |alloc_0| |memor_0|)
       (and (not (bvuge (bvadd |main::1::j| (_ bv1 64)) |main::1::i|))
       (not (bvuge |main::1::j| |main::1::L|)))) 
...
(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|main::1::j| (_ BitVec 64)))
  (=> (and 
    (|inv_3| |main::1::j| |alloc_0| |memor_0|)
       (not (bvsge (select (select |memor_0| (select |alloc_0| (_ bv1 64))) (bvadd |main::1::j| (_ bv1 64))) (select (select |memor_0| (select |alloc_0| (_ bv1 64))) |main::1::j|)))
       (= (select |alloc_0| (_ bv1 64)) (_ bv0 64))) false)))

(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|main::1::j| (_ BitVec 64)))
  (=> (and 
    (|inv_3| |main::1::j| |alloc_0| |memor_0|)
       (not (bvsge (select (select |memor_0| (select |alloc_0| (_ bv1 64))) (bvadd |main::1::j| (_ bv1 64))) (select (select |memor_0| (select |alloc_0| (_ bv1 64))) |main::1::j|)))) false)))

(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|main::1::j| (_ BitVec 64)))
  (=> (and 
    (|inv_3| |main::1::j| |alloc_0| |memor_0|)
       (bvsge (select (select |memor_0| (select |alloc_0| (_ bv1 64))) (bvadd |main::1::j| (_ bv1 64))) (select (select |memor_0| (select |alloc_0| (_ bv1 64))) |main::1::j|))
       (= (select |alloc_0| (_ bv1 64)) (_ bv0 64))) false)))
