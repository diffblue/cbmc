...
(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|main::1::m| (_ BitVec 64)) (|main::1::i| (_ BitVec 64)))
  (=> (and 
    (|inv_3| |main::1::m| |main::1::i| |alloc_0| |memor_0|)
       (not (bvsle |main::1::m| (select (select |memor_0| (select |alloc_0| (_ bv1 64))) |main::1::i|)))
       (= (select |alloc_0| (_ bv1 64)) (_ bv0 64))) false)))

(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|main::1::m| (_ BitVec 64)) (|main::1::i| (_ BitVec 64)))
  (=> (and 
    (|inv_3| |main::1::m| |main::1::i| |alloc_0| |memor_0|)
       (not (bvsle |main::1::m| (select (select |memor_0| (select |alloc_0| (_ bv1 64))) |main::1::i|)))) false)))

(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|main::1::m| (_ BitVec 64)) (|main::1::i| (_ BitVec 64)))
  (=> (and 
    (|inv_3| |main::1::m| |main::1::i| |alloc_0| |memor_0|)
       (bvsle |main::1::m| (select (select |memor_0| (select |alloc_0| (_ bv1 64))) |main::1::i|))
       (= (select |alloc_0| (_ bv1 64)) (_ bv0 64))) false)))
