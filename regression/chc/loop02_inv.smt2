...
(assert (forall ((|main::1::1::i| (_ BitVec 32)) (|main::1::x| (_ BitVec 32)))
  (=> true 
    (|inv_5| |main::1::1::i| |main::1::x|))))

(declare-fun |inv_3| ((_ BitVec 32) (_ BitVec 32) ) Bool)

(assert (forall ((|main::1::1::i| (_ BitVec 32)) (|main::1::1::i_1| (_ BitVec 32)) (|main::1::1::i_2| (_ BitVec 32)) (|main::1::x| (_ BitVec 32)) (|main::1::x_1| (_ BitVec 32)) (|main::1::x_2| (_ BitVec 32)))
  (=> (and 
    (|inv_5| |main::1::1::i_2| |main::1::x_2|)
...
(assert (forall ((|main::1::1::i| (_ BitVec 32)) (|main::1::x| (_ BitVec 32)))
  (=> (and 
    ...
    (|inv_4| |main::1::1::i| |main::1::x|))))

(assert (forall ((|main::1::1::i| (_ BitVec 32)) (|main::1::1::i_1| (_ BitVec 32)) (|main::1::1::i_2| (_ BitVec 32)) (|main::1::x| (_ BitVec 32)) (|main::1::x_1| (_ BitVec 32)) (|main::1::x_2| (_ BitVec 32)))
  (=> (and 
    (|inv_4| |main::1::1::i_2| |main::1::x_2|)
       (= |main::1::1::i_2| |main::1::1::i_1|)
