...
(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|memor_1| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|memor_2| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|alloc_1| (Array (_ BitVec 64) (_ BitVec 64))) (|alloc_2| (Array (_ BitVec 64) (_ BitVec 64))) (|main::1::i| (_ BitVec 64)))
  (=> (and 
    (|inv_4| |main::1::i| |alloc_2| |memor_2|)
       (= |memor_0| (store |memor_1| (select |alloc_0| (_ bv2 64)) (store (select |memor_1| (select |alloc_0| (_ bv2 64))) (bvadd |main::1::i| (_ bv1 64)) (bvadd (select (select |memor_1| (select |alloc_0| (_ bv2 64))) |main::1::i|) (_ bv8 64)))))
       (= |alloc_0| (store |alloc_1| (_ bv2 64) (select |alloc_1| (_ bv1 64))))
       (= |memor_1| (store |memor_2| (select |alloc_1| (_ bv1 64)) (store (select |memor_2| (select |alloc_1| (_ bv1 64))) |main::1::i| (_ bv53 64))))
...
(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|main::1::i| (_ BitVec 64)))
  (=> (and 
    (|inv_3| |main::1::i| |alloc_0| |memor_0|)
       (not (bvsgt (select (select |memor_0| (select |alloc_0| (_ bv1 64))) (bvadd |main::1::i| (_ bv1 64))) (select (select |memor_0| (select |alloc_0| (_ bv1 64))) |main::1::i|)))) false)))
...
(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|main::1::i| (_ BitVec 64)))
  (=> (and 
    (|inv_3| |main::1::i| |alloc_0| |memor_0|)
       (bvsgt (select (select |memor_0| (select |alloc_0| (_ bv1 64))) (bvadd |main::1::i| (_ bv1 64))) (select (select |memor_0| (select |alloc_0| (_ bv1 64))) |main::1::i|))) 
