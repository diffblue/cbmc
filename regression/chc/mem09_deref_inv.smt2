...
(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|memor_1| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|memor_2| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))) (|alloc_1| (Array (_ BitVec 64) (_ BitVec 64))) (|alloc_2| (Array (_ BitVec 64) (_ BitVec 64))) (|main::$tmp::return_value_nondet_int$4_2| (_ BitVec 32)) (|main::1::1::t1| (_ BitVec 64)) (|main::1::1::t1_1| (_ BitVec 64)) (|main::1::1::t1_2| (_ BitVec 64)) (|main::1::1::t2| (_ BitVec 64)) (|main::1::1::t2_1| (_ BitVec 64)) (|main::1::1::t2_2| (_ BitVec 64)) (|main::1::i_2| (_ BitVec 64)) (|main::1::j_1| (_ BitVec 64)) (|main::1::j_2| (_ BitVec 64)))
  (=> (and 
    (|inv_6| |main::$tmp::return_value_nondet_int$4_2| |main::1::1::t1_2| |main::1::1::t2_2| |main::1::i_2| |main::1::j_2| |alloc_2| |memor_2|)
       ...
       (= |main::1::j_2| |main::1::j_1|)
       (= |main::1::1::t1_1| |main::1::1::t1|)
       (= (bvadd (select (select |memor_0| (select |alloc_0| (_ bv6907487098696 64))) |main::1::j_1|) (select (select |memor_0| (select |alloc_0| (_ bv620109269044 64))) |main::1::j_1|)) |main::1::1::t2|)
       (or (= (select |alloc_0| (_ bv6907487098696 64)) (_ bv0 64)) (= (select |alloc_0| (_ bv620109269044 64)) (_ bv0 64)) (= (select |alloc_1| (_ bv6053561456450 64)) (_ bv0 64)) (= (select |alloc_2| (_ bv6053561456450 64)) (_ bv0 64)) (= (select |alloc_2| (_ bv9363835545496 64)) (_ bv0 64)) (= (select |alloc_2| (_ bv9363835545496 64)) (_ bv0 64)))) false)))
...
(assert (forall ((|memor_0| (Array (_ BitVec 64) (Array (_ BitVec 64) (_ BitVec 64)))) (|alloc_0| (Array (_ BitVec 64) (_ BitVec 64))))
  (=> (and 
    (|inv_3| |alloc_0| |memor_0|)
       (not (= (select (select |memor_0| (select |alloc_0| (_ bv9363835545496 64))) (_ bv0 64)) (select (select |memor_0| (select |alloc_0| (_ bv6053561456450 64))) (_ bv0 64))))
       (or (= (select |alloc_0| (_ bv6053561456450 64)) (_ bv0 64)) (= (select |alloc_0| (_ bv9363835545496 64)) (_ bv0 64)))) false)))
