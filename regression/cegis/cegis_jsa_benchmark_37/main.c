...
int main(void)
{
  ...
  const __CPROVER_jsa_list_id_t __CPROVER_jsa_list_candidates=0;
  __CPROVER_jsa_assume_valid_list(&heap, __CPROVER_jsa_list_candidates);
  const __CPROVER_jsa_list_id_t __CPROVER_jsa_list_cand=1;
  __CPROVER_jsa_assume_new_list(&heap, __CPROVER_jsa_list_cand);
  for (const __CPROVER_jsa_iterator_id_t __CPROVER_jsa_iterator_it=__CPROVER_jsa_iterator(&heap, __CPROVER_jsa_list_candidates);
       __CPROVER_jsa_hasNext(&heap, __CPROVER_jsa_iterator_it);)
  {
    ...
    __CPROVER_jsa_add(&heap, __CPROVER_jsa_list_cand, integer);
  }
