...
int main(void)
{
  ...
  __CPROVER_synthesis_writeonly_result=nondet_int();
  __CPROVER_synthesis_root();
  __CPROVER_assert(__CPROVER_synthesis_writeonly_result == __CPROVER_synthesis_arg_x + __CPROVER_synthesis_arg_y, "");
  return 0;
}
