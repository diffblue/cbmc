...
int main()
{
  ...
  _Float16 nan_f16 = (_Float16)(0.0 / 0.0);

  // NaN edge cases: remainder with any NaN input yields NaN
  assert(
    __CPROVER_remainderf16(nan_f16, (_Float16)1.0) !=
    __CPROVER_remainderf16(nan_f16, (_Float16)1.0));
  assert(
    __CPROVER_remainderf16((_Float16)1.0, nan_f16) !=
    __CPROVER_remainderf16((_Float16)1.0, nan_f16));
  // remainder(x, 0) and remainder(inf, y) yield NaN
  assert(
    __CPROVER_remainderf16((_Float16)1.0, (_Float16)0.0) !=
    __CPROVER_remainderf16((_Float16)1.0, (_Float16)0.0));
  assert(
    __CPROVER_remainderf16(pos_inf_f16, (_Float16)1.0) !=
    __CPROVER_remainderf16(pos_inf_f16, (_Float16)1.0));

  // Core property: for finite, non-zero, non-NaN inputs,
  // |remainder(x, y)| <= |y| / 2
  _Float16 x, y;
