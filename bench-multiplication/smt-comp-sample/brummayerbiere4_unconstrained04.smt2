...
(assert (let ((?v_0 (bvudiv v1 v3))) (not (= (ite (not (= (bvudiv (bvudiv (bvudiv v4 v3) (bvmul v2 v5)) (bvmul (bvudiv (bvudiv v1 v2) ?v_0) (bvmul (bvudiv v2 v3) (bvmul v4 v5)))) (bvadd v6 ?v_0))) (_ bv1 1) (_ bv0 1)) (_ bv0 1)))))
(check-sat)
(exit)
