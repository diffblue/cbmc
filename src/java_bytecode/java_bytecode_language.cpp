...
Function: java_bytecode_languaget::provide_string_methods_code
...
void java_bytecode_languaget::provide_string_methods_code(
...
bool java_bytecode_languaget::final(symbol_tablet &symbol_table)
{
  ...
  */
  ...
  provide_string_methods_code(symbol_table);
