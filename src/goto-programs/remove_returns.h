...
typedef std::function<bool(irep_idt)> function_is_stubt;
...
irep_idt return_value_identifier(irep_idt);

/// produces the symbol that is used to store the return
/// value of the function with the given identifier
symbol_exprt return_value_symbol(irep_idt, const namespacet &);
