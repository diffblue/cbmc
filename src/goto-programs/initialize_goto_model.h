...
/// Read and link goto binaries listed in \p binaries into \p goto_model.
/// Throws an exception if processing of any binary fails.
/// \param binaries: Collection of goto binary file names. No operation is performed
///   if the vector is empty.
/// \param [out] goto_model: GOTO model to be populated.
/// \param message_handler: Message handler.
void read_goto_binaries_and_link(
