...
protected:
  ...
  bool _found_dispatch_loop_location;
  source_locationt _dispatch_loop_location;

public:
  source_locationt &dispatch_loop_location()
  {
    return _dispatch_loop_location;
  }
  bool found_dispatch_loop_location()
  {
    return _found_dispatch_loop_location;
  }
