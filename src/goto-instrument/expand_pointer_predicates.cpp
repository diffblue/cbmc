...
void expand_pointer_predicatest::expand_pointer_predicates()
{
  Forall_goto_functions(f_it, goto_functions)
  {
    ...
    local_bitvector_analysist local_bitvector_analysis_obj(goto_function, ns);
    ...
    Forall_goto_program_instructions(i_it, goto_function.body)
    {
      ...
      {
        expand_assumption(goto_function.body, i_it, i_it->guard);
        local_bitvector_analysis_obj =
          local_bitvector_analysist(goto_function, ns);
        local_bitvector_analysis = &local_bitvector_analysis_obj;
      }
      else
      {
      ...
      it != assume_expr.depth_end();)
  {
    if(it->id() == ID_points_to_valid_memory)
    {
      ...
      local_bitvector_analysist::flagst flags =
        local_bitvector_analysis->get(target, pointer_expr, ns);
