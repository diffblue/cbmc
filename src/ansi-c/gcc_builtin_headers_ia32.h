...
__gcc_v2si __builtin_ia32_pand(__gcc_di, __gcc_di);
__gcc_v2si __builtin_ia32_pandn(__gcc_di, __gcc_di);
__gcc_v2si __builtin_ia32_por(__gcc_di, __gcc_di);
__gcc_v2si __builtin_ia32_pxor(__gcc_di, __gcc_di);
