...
#ifndef CPROVER_ANSI_C_GOTO_CONVERSION_GOTO_CONVERT_CLASS_H
#define CPROVER_ANSI_C_GOTO_CONVERSION_GOTO_CONVERT_CLASS_H
...
#endif // CPROVER_GOTO_PROGRAMS_GOTO_CONVERSION_GOTO_CONVERT_CLASS_H
