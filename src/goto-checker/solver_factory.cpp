...
std::unique_ptr<solver_factoryt::solvert> solver_factoryt::get_default()
{
  ...
  auto bv_pointers = util_make_unique<bv_pointerst>(ns, solver->prop(), message_handler);
...
std::unique_ptr<solver_factoryt::solvert> solver_factoryt::get_dimacs()
{
  ...
  auto bv_dimacs = util_make_unique<bv_dimacst>(ns, *prop, filename, message_handler);
...
std::unique_ptr<solver_factoryt::solvert> solver_factoryt::get_bv_refinement()
{
  ...
  auto prop_conv = util_make_unique<bv_refinementt>(info, message_handler);
