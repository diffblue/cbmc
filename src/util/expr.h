...
public:
  ...
  DEPRECATED(SINCE(2025, 6, 25, "use constant_exprt::is_true() instead"))
  bool is_true() const;
  DEPRECATED(SINCE(2025, 6, 25, "use constant_exprt::is_false() instead"))
  bool is_false() const;
  DEPRECATED(SINCE(2025, 6, 25, "use constant_exprt::is_zero() instead"))
  bool is_zero() const;
  DEPRECATED(SINCE(2025, 6, 25, "use constant_exprt::is_one() instead"))
  bool is_one() const;
