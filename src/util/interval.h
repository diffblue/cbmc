...
public:
  ...
  constant_interval_exprt():
    constant_interval_exprt(min_exprt(nil_typet()), max_exprt(nil_typet()), nil_typet())
  {
...
//  tvt contains(constant_interval_exprt &o) const;
  ...
  friend std::ostream& operator<< (std::ostream& out, const constant_interval_exprt &i);
...
private:
  ...
  static exprt generate_expression(const exprt &lhs, const exprt &rhs, const irep_idt &operation);
  static exprt generate_multiply_expression(const exprt &lower, const exprt &upper);
...
inline const constant_interval_exprt& to_constant_interval_expr(const exprt& expr) {
