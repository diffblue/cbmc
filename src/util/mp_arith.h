...
mp_integer arith_left_shift(const mp_integer &, 
                            const mp_integer &,unsigned true_size);

mp_integer arith_right_shift(const mp_integer &,
                            const mp_integer &,unsigned true_size);

mp_integer logic_left_shift(const mp_integer &, 
                            const mp_integer &,unsigned true_size);

mp_integer logic_right_shift(const mp_integer &, 
                             const mp_integer &,unsigned true_size);

mp_integer rotate_right(const mp_integer &, 
                        const mp_integer &,unsigned true_size);

mp_integer rotate_left(const mp_integer &,
                       const mp_integer &,unsigned true_size);
