...
public:
  ...
  {
    size_type na = static_cast<size_type>(it_a - numbers.begin()),
              nb = static_cast<size_type>(it_b - numbers.begin());
    bool is_union=find_number(na)==find_number(nb);
    uuf.make_union(na, nb);
    return is_union;
  }
  ...
  {
    return uuf.same_set(
      static_cast<size_type>(it_a - numbers.begin()),
      static_cast<size_type>(it_b - numbers.begin()));
  }

  const T &find(typename numbering<T>::const_iterator it) const
  {
    return numbers[find_number(static_cast<size_type>(it - numbers.begin()))];
  }
  ...
  {
    return find_number(static_cast<size_type>(it - numbers.begin()));
  }
  ...
  {
    return uuf.is_root(static_cast<size_type>(it - numbers.begin()));
  }
  ...
  {
    uuf.isolate(static_cast<size_type>(it - numbers.begin()));
  }
