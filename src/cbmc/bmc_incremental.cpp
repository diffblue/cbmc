...
Function: bmc_incrementalt::initialize
...
safety_checkert::resultt bmc_incrementalt::initialize()
{
...
#if 0
    debug() << "symex" << (symex_done ? " " : " not ") << "done" << eom;
#endif
...
Function: bmc_incrementalt::decide
...
safety_checkert::resultt bmc_incrementalt::decide(
