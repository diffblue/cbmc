...
void symex_parse_optionst::help()
{
  ...
  std::cout <<
    ...
    " --remove-ternary             rewrite ternary operators into if statements\n"
    "\n"
    "Symex options:\n"
    ...
    " --taint engine               activate a taint engine.\n"
    " --taint-file file            specify a taint definitions file.\n"
    " --show-taint-data            output the taint data within the JSON file.\n"
    "\n"
    "Other options:\n"
