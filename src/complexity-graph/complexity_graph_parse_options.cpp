///*******************************************************************\
//
//Module: CBMC Complexity Graph Command Line Option Processing
//
...
//
///// \file
///// CBMC Complexity Graph Command Line Option Processing
//
...
//
//complexity_graph_parse_optionst::complexity_graph_parse_optionst(int argc, const char **argv)
//  : parse_options_baset(
//      COMPLEXITY_GRAPH_OPTIONS,
//      argc,
//      argv,
//      std::string("COMPLEXITY_GRAPH ") + COMPLEXITY_GRAPH_VERSION)
//{
//  json_interface(cmdline, ui_message_handler);
//  xml_interface(cmdline, ui_message_handler);
//}
//
//::complexity_graph_parse_optionst::complexity_graph_parse_optionst(
//  int argc,
//  const char **argv,
//  const std::string &extra_options)
//  : parse_options_baset(
//      COMPLEXITY_GRAPH_OPTIONS + extra_options,
//      argc,
//      argv,
//      std::string("COMPLEXITY_GRAPH ") + COMPLEXITY_GRAPH_VERSION)
//{
...
//}
//
//void complexity_graph_parse_optionst::set_default_options(optionst &options)
//{
//  // Default true
...
//}
//
//void complexity_graph_parse_optionst::get_command_line_options(optionst &options)
//{
...
//  }
//
//  complexity_graph_parse_optionst::set_default_options(options);
...
//
///// invoke main modules
//int complexity_graph_parse_optionst::doit()
//{
//  if(cmdline.isset("version"))
//  {
//    std::cout << COMPLEXITY_GRAPH_VERSION << '\n';
...
//
//  log_version_and_architecture("COMPLEXITY_GRAPH");
//
//  //
...
//
//  /*
//    if(cmdline.isset("show-complexity-graph") ||
//       cmdline.isset("show-complexity-graph-roots"))
//    {
//      show_complexity_graph(
//        goto_model, cmdline.get_values("show-complexity-graph-roots"), ui_message_handler);
//      return CPROVER_EXIT_SUCCESS;
//    }
//    */
//
...
//}
//
//bool complexity_graph_parse_optionst::set_properties()
//{
...
//}
//
//int complexity_graph_parse_optionst::get_goto_program(
...
//  }
//
//  if(complexity_graph_parse_optionst::process_goto_program(goto_model, options, log))
...
//}
//
//void complexity_graph_parse_optionst::preprocessing(const optionst &options)
//{
...
//}
//
//bool complexity_graph_parse_optionst::process_goto_program(
//  goto_modelt &goto_model,
//  const optionst &options,
//  messaget &log)
//{
...
//void complexity_graph_parse_optionst::help()
//{
//  // clang-format off
...
//    "Usage:                       Purpose:\n"
//    "\n"
//    " complexity_graph [-?] [-h] [--help]      show help\n"
//    " complexity_graph file.c ...              source file names\n"
//    "\n"
//    "Analysis options:\n"
...
//    HELP_CONFIG_BACKEND
//    HELP_SOLVER
//    HELP_STRING_REFINEMENT_COMPLEXITY_GRAPH
