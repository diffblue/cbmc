  ...
  const function_application_exprt &f)
{
  ...
  lemmas_.push_back(res.axiom_for_has_length(k));
  ...
  a3.body=equal_exprt(res[idx2], constant_char(0, ref_type.get_char_type()));
  ...
  const string_exprt &str, const exprt &start, const exprt &end)
{
  ...
  lemmas_.push_back(str.axiom_for_length_ge(end));
  ...
  const function_application_exprt &f)
{
  ...
  lemmas_.push_back(res.axiom_for_has_same_length_as(str));
