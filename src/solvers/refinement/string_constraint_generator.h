...
public:
  ...
  string_exprt function_application(const function_application_exprt &expr);
  ...
  exprt string_index_string(const string_exprt &str, const string_exprt & substring, const exprt & from_index);
