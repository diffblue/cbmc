...
void smt2_convt::convert_expr(const exprt &expr)
{
  ...
  else if(expr.id()==ID_unary_minus)
  {
    ...
    else if(expr.type().id()==ID_floatbv)
    {
      if(use_FPA_theory)
      {
        smt2_prop.out << "(fp.neg "; // no rounding
        convert_expr(expr.op0());
        smt2_prop.out << ")";
      }
      else
  ...
  else if(expr.id()==ID_abs)
  {
    ...
    else if(type.id()==ID_floatbv)
    {
      ...
      if(use_FPA_theory)
      {
          smt2_prop.out << "(ite (fp.lt ";
          convert_expr(expr.op0());
          smt2_prop.out << " (fp 0x0 0x0 0x0)";
          smt2_prop.out << "(fp.neg ";
          convert_expr(expr.op0());
          smt2_prop.out << ") ";
          convert_expr(expr.op0());
          smt2_prop.out << ")";
  ...
  else if(expr.id()==ID_isfinite)
  {
    ...
    else if(op_type.id()==ID_floatbv)
    {
      ...
      if(use_FPA_theory)
      {
          ...
          smt2_prop.out << ")) ";
          smt2_prop.out << "(and ";
          smt2_prop.out << "(fp.lt (_ -oo " << e << " " << f << ") ?op) ";
          smt2_prop.out << "(fp.lt ?op (_ +oo " << e << " " << f << ")))";
          smt2_prop.out << ")";
      }
      else
      {
...
void smt2_convt::convert_typecast(const typecast_exprt &expr)
{
          ...
          expr_type.id()==ID_c_enum)
  {
    ...
    else if(op_type.id()==ID_floatbv) // from floatbv to int
    {
      ...
      if(use_FPA_theory)
      {
        smt2_prop.out << "((_ fp.to_sbv " << to_width << ") ";
        convert_expr(op);
        smt2_prop.out << ")";
      }
      else
...
//      const floatbv_typet &src=to_floatbv_type(op_type);
      ...
      if(use_FPA_theory)
      {
        smt2_prop.out << "((_ to_fp " << dst.get_e() << " "
    ...
    else if(op_type.id()==ID_unsignedbv)
    {
      ...
      if(use_FPA_theory)
      {
        smt2_prop.out << "((_ to_fp_unsigned " << dst.get_e() << " "
                      << dst.get_f() + 1 << ") roundNearestTiesToEven ";
        convert_expr(op);
        smt2_prop.out << ")";
      }
  ...
  else if(expr.type().id()==ID_floatbv)
  {
    ...
    if(use_FPA_theory)
    {
	 ...
	 is needed to get to IEEE-754 style representations*/
      ...
      smt2_prop.out << "((_ to_fp " << e << " " << f << ")"
		    << " #b" << integer2binary(v.pack(), v.spec.width()) << ")";
#endif

      if (v.is_NaN())
      {
	smt2_prop.out << "(_ NaN " << e << " " << f << ")";
      }
      else if (v.is_infinity())
      {
	if (v.get_sign())
	{
	  smt2_prop.out << "(_ -oo " << e << " " << f << ")";
	}
	else
	{
	  smt2_prop.out << "(_ +oo " << e << " " << f << ")";
...
void smt2_convt::convert_plus(const plus_exprt &expr)
{
  ...
  else if(expr.type().id()==ID_floatbv)
  {
    ...
    if(use_FPA_theory)
    {
      smt2_prop.out << "(fp.add roundNearestTiesToEven ";
...
void smt2_convt::convert_floatbv_plus(const exprt &expr)
{
  ...
  if(use_FPA_theory)
  {
    smt2_prop.out << "(fp.add ";
    smt2_prop.out << "roundNearestTiesToEven"; // hard-wired : FIX!
    smt2_prop.out << " ";
    convert_expr(expr.op0());
    smt2_prop.out << " ";
    convert_expr(expr.op1());
...
void smt2_convt::convert_minus(const minus_exprt &expr)
{
  ...
  else if(expr.type().id()==ID_floatbv)
  {
    if(use_FPA_theory)
    {
      smt2_prop.out << "(fp.sub roundNearestTiesToEven ";
      convert_expr(expr.op0());
      smt2_prop.out << " ";
      convert_expr(expr.op1());
      smt2_prop.out << ")";
...
void smt2_convt::convert_div(const div_exprt &expr)
{
  ...
  else if(expr.type().id()==ID_fixedbv)
  {
    ...
    smt2_prop.out << "((_ extract " << spec.width-1 << " 0) ";
    smt2_prop.out << "(bvsdiv ";
  ...
  else if(expr.type().id()==ID_floatbv)
  {
    if(use_FPA_theory)
    {
      smt2_prop.out << "(fp.div roundNearestTiesToEven ";
      convert_expr(expr.op0());
      smt2_prop.out << " ";
      convert_expr(expr.op1());
      smt2_prop.out << ")";
...
void smt2_convt::convert_floatbv_div(const exprt &expr)
{
  ...
  if(use_FPA_theory)
  {
    smt2_prop.out << "(fp.div ";
    smt2_prop.out << "roundNearestTiesToEven";
    smt2_prop.out << " ";
    convert_expr(expr.op0());
    smt2_prop.out << " ";
    convert_expr(expr.op1());
    ...
    if(use_FPA_theory)
    {
      forall_operands(it, expr)
        if(it!=expr.operands().begin())
          smt2_prop.out << "(fp.mul roundNearestTiesToEven ";
