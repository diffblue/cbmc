  ...
  array_poolt &array_pool)
{
  ...
  const exprt &end = args.size() >= 5 ? args[4] : array_pool.get_length(s);
  ...
  array_poolt &array_pool)
{
  ...
  const exprt count = args.size() == 3 ? array_pool.get_length(str) : args[4];
  ...
  array_poolt &array_pool)
{
  ...
  return {array_pool.get_length(str), {}};
}
