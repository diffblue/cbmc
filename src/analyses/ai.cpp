  ...
  const irep_idt &identifier) const
{
  ...
  forall_goto_program_instructions(i_it, goto_program)
  {
    ...
    location["location_number"] = json_numbert(std::to_string(i_it->location_number));
    location["source_location"] = json_stringt(i_it->source_location.as_string());
  ...
  const irep_idt &identifier) const
{
  ...
  {
    xmlt location;
    location.set_attribute("location_number", std::to_string(i_it->location_number));
    location.set_attribute("source_location", i_it->source_location.as_string());
