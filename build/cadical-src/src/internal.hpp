...
struct Internal {
  ...
  Clause *gauss_reason;
  GaussPropagator *gauss = nullptr;
  Clause *learn_gauss_reason_clause(int ilit);
  ...
  vector<int> priority_decisions; // variables to decide first
