  ...
  methodt::instructionst &instructions)
{
  ...
  for(address=0; address<code_length; address++)
  {
    ...
    case 'o': // two byte branch offset, signed
      {
        s2 offset = static_cast<s2>(read_u2());
    ...
    case 'O': // four byte branch offset, signed
      {
        s4 offset = static_cast<s4>(read_u4());
        // By converting the signed offset into an absolute address (by adding
        // the current address) the number represented becomes unsigned.
        instruction.args.push_back(
    ...
    case 'L': // lookupswitch
      {
        ...
        // now default value
        s4 default_value = static_cast<s4>(read_u4());
        // By converting the signed offset into an absolute address (by adding
        // the current address) the number represented becomes unsigned.
        instruction.args.push_back(
        ...
        {
          s4 match = static_cast<s4>(read_u4());
          s4 offset = static_cast<s4>(read_u4());
          instruction.args.push_back(
    ...
    case 'T': // tableswitch
      {
        ...
        // now low value
        s4 low_value = static_cast<s4>(read_u4());
        address+=4;

        // now high value
        s4 high_value = static_cast<s4>(read_u4());
        address+=4;
